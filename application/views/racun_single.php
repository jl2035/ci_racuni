...
$html.= '<br><strong>'.$racun_beseda.' št.: '.$racun['id'].'</strong><br><br><br>';
...
$html .= $table2;
if(!$racun['predracun'])
	$html .= '<p>Plačilo lahko izvršite z univerzalnim plačilnim nalogom UPN na transakcijski račun:<br>'.$racun['narocnik']->trr.'.<br>Pri plačilu obvezno navedite naslednjo referenco: SI00 '.date('Y').$racun['id'].'</p>';
